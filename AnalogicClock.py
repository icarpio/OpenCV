"""
Analogic with Clock OpenCV & Python
Created on Fri Aug  2 21:43 2019
...
# We draw the rectangle containig the text
cv2.rectangle(image, (150, 275), (490, 370), colors['dark_gray'], -1)
cv2.putText(image, "OpenCV 4 & Python", (150, 310), 1, 2, colors['light_gray'], 1, cv2.LINE_AA)
cv2.putText(image, "Icarpio", (270, 360), 1, 2, colors['light_gray'], 1, cv2.LINE_AA)
...
while True:
    ...
    cv2.line(image, (320, 320), (minute_x, minute_y), colors['rand'], 8)

    hour_x = round(320 + 220 * math.cos(hour_angle * 3.14 / 180))
    hour_y = round(320 + 220 * math.sin(hour_angle * 3.14 / 180))
    cv2.line(image, (320, 320), (hour_x, hour_y), colors['rand'], 10)
    ...
    # Show image:
    cv2.imshow("ICarpio Clock ", image)
